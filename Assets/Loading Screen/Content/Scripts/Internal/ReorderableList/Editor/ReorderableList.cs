	...
	public class ReorderableList {
		...
		*/
		...
		private void DrawPaginationHeader(Rect rect) {
            ...
            EditorGUI.IntField(pageSizeRect, Style.listIcon, useFixedPageSize ? pagination.fixedPageSize : pagination.customPageSize, style);
#if UNITY_5_6_OR_NEWER
...
#else
            int newPageSize = EditorGUI.IntField(pageSizeRect, Style.listIcon, useFixedPageSize ? pagination.fixedPageSize : pagination.customPageSize, style);
#endif
